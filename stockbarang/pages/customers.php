...
require_permission('view_stock'); // boleh dilihat semua role (viewer/staff/admin)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    if ($act === 'create') {
      if ($nama === '') throw new Exception('Nama customer wajib diisi.');
      $stmt = $koneksi->prepare("INSERT INTO customers (nama, alamat, telp, pic) VALUES (?, ?, ?, ?)");
      ...
      if ($nama === '') throw new Exception('Nama customer wajib diisi.');
      $stmt = $koneksi->prepare("UPDATE customers SET nama=?, alamat=?, telp=?, pic=? WHERE id=?");
...
<div class="container-fluid px-3 px-xl-4">
  <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
    <h1 class="fw-bold mb-2">Customer</h1>
  ...
  <div class="card">
    <div class="card-header">
      <i class="fa-solid fa-table-list me-1"></i> Data Customer
    ...
    <div class="card-body">
      <?php if (empty($rows)): ?>
        <div class="empty-state">
          ...
          <p class="text-muted mb-0">Klik tombol <b>Tambah</b> untuk menambahkan customer baru.</p>
        </div>
      <?php else: ?>
...
<div class="modal fade" id="mdlCreate" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <form method="post" class="modal-content">
      ...
      <div class="modal-header"><h5 class="modal-title">Tambah Customer</h5>
